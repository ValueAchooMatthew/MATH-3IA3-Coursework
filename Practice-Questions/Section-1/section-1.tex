...
\begin{solution}
	...
	\begin{step}
		Show that $A \cap (B \cup C) \supseteq (A \cap B) \cup (A \cap C)$.
	\end{step}
...
\begin{solution}
	...
	\begin{step}
		Show that $A \cup (B \cap C) \subseteq (A \cup B) \cap (A \cup C)$.
	\end{step}
	...
	\begin{step}
		Show that $A \cup (B \cap C) \supseteq (A \cup B) \cap (A \cup C)$.
	\end{step}
...
\begin{subexercise}
	Find the direct image $h(E)$ of $E \coloneq \{x \in \mathbb{R}: 0 \le x \le 1\}$.
\end{subexercise}
...
\begin{subexercise}
	Find the inverse image $h^{-1}(G)$ of $G \coloneq \{x \in \mathbb{R}: 0 \le x \le 4\}$.
\end{subexercise}
...
\begin{subexercise}
	Show that if $f: A \rightarrow B$ is injective and $E \subseteq A$, then $f^{-1}(f(E)) = E$. Give an example to show that equality need not hold if $f$
	is not injective.
\end{subexercise}
...
\begin{subexercise}
	Show that if $f: A \rightarrow B$ is surjective and $H \subseteq B$, then $f(f^{-1}(H)) = H$. Give an example to show that equality need not hold if $f$ is not surjective.
\end{subexercise}
...
\begin{solution}
	\begin{proof}
		...
		\begin{step}
			Show the base case holds (Prove $P(1)$ is true).
		\end{step}
		...
		\begin{step}
			State induction hypothesis (State $P(k)$).
		\end{step}
...
\begin{solution}
	\begin{proof}
		...
		\begin{step}
			Show the base case holds (Prove $P(1)$ true).
		\end{step}
...
\begin{solution}
	...
	\begin{proof}
		...
		\begin{step}
			Show base case holds (Prove $P(1)$ true).
		\end{step}
...
\begin{solution}
	...
	\begin{proof}
		...
		\begin{step}
			Formulate induction hypothesis (State $P(k)$).
		\end{step}
...
\begin{subexercise}
	Determine the number of different injections from $S$ into $T$.
\end{subexercise}
...
\begin{subexercise}
	Determine the number of different surjections from $T$ onto $S$.
\end{subexercise}
...
\begin{solution}
	\begin{proof}
		...
		\begin{step}
			Prove the forward direction ($T_1$ is denumerable $\implies$ there exists a bijection from $T_1$ to a denumerable set $T_2$).
		\end{step}
		...
		\begin{step}
			Prove the reverse direction (A bijection from $T_1$ to a denumerable set $T_2 \implies T_1$ is denumerable),
		\end{step}
